	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">管理側　登録フォーム</div>
				<div class="panel-body">
					<form role="form">
						<fieldset>
                            ...
                            <div class="form-group">
								<input class="form-control" placeholder="パスワードの確認" name="password" type="password" autofocus="">
							</div>
							<div class="checkbox">
								<label>
                            ...
                            <a href="index.html" class="btn btn-primary">登録</a>
                        </fieldset>
					</form>
				</div>
			</div>
