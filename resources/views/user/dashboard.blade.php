            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                <div class="col-6 pr-1">
                  <img src="{{ asset('library/PurpleAdmin-Free-Admin-Template-master/assets/images/dashboard/img_1.jpg') }}" class="mb-2 mw-100 w-100 rounded" alt="image">
                  <img src="{{ asset('library/PurpleAdmin-Free-Admin-Template-master/assets/images/dashboard/img_4.jpg') }}" class="mw-100 w-100 rounded" alt="image">
                </div>
                <div class="col-6 pl-1">
                  <img src="{{ asset('library/PurpleAdmin-Free-Admin-Template-master/assets/images/dashboard/img_2.jpg') }}" class="mb-2 mw-100 w-100 rounded" alt="image">
                  <img src="{{ asset('library/PurpleAdmin-Free-Admin-Template-master/assets/images/dashboard/img_3.jpg') }} " class="mw-100 w-100 rounded" alt="image">
                </div>
              </div>
              <div class="d-flex mt-5 align-items-top">
                <img src="{{ asset('library/PurpleAdmin-Free-Admin-Template-master/assets/images/faces/face3.jpg') }}" class="img-sm rounded-circle mr-3" alt="image">
